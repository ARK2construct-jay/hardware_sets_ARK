...
async function renameHagerGrade1ToModel() {
  try {
    ...
    console.log(`Updated ${result.modifiedCount} Hager Residential Hardware records`);
    ...
    mongoose.disconnect();
    console.log('Hager field rename completed successfully!');
  } catch (error) {
    console.error('Error:', error.message);
  }
}

renameHagerGrade1ToModel();